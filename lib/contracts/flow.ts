...
const zRule = z.discriminatedUnion("kind", [
  ...
  z.object({ kind: z.literal("field_match"), left: zRef, right: zRef, mode: z.enum(["equal", "different"]).optional(), numericTolerance: z.number().optional(), normalizer: z.enum(["auto", "date", "number", "identifier", "name", "text"]).optional() }),
